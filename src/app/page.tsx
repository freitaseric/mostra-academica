          ...
          <div className="flex flex-col justify-center items-center w-screen md:w-auto">
            ...
            >
              ...
              <AccordionItem value="2">
                ...
                <AccordionContent className="text-wrap text-justify md:text-xs lg:text-lg">
                  Algumas universidades públicas renomadas que oferecem o curso
                  de Ciência da Computação são as{' '}
                  <strong>universidades federais</strong> de diversos estados,
                  incluindo a{' '}
                  <strong>Universidade Federal de Roraima (UFRR)</strong>. Na
                  rede privada, destam-se instituições como a{' '}
                  <strong>Estácio</strong>, <strong>Anhanguera</strong>,{' '}
                  <strong>Unip</strong>, <strong>Unifacs</strong>, entre outras.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="3">
                ...
                <AccordionContent className="text-wrap text-justify md:text-xs lg:text-lg">
                  O mercado de trabalho para um cientista da computação é
                  bastante promissor, com salários que podem atingir até{' '}
