...
export default function Home() {
  return (
    <>
      <AppHeader />
      <main className="flex flex-col justify-center items-center gap-16 md:flex-row md:justify-around md:gap-0">
        <div className="flex flex-col justify-center items-center">
          <h1 className="font-bold text-2xl mdtext-3xl">
            Ciência da Computação
          </h1>
          <h2 className="flex flex-row justify-between items-center gap-4 text-md">
        ...
        <div className="flex flex-col justify-center items-center w-screen md:w-auto">
          <Accordion type="single" collapsible className="w-[75%] md:w-96">
            <AccordionItem value="1">
              <AccordionTrigger>
                O que posso aprender no curso?
              </AccordionTrigger>
              <AccordionContent className="text-wrap text-justify">
            ...
            <AccordionItem value="2">
              <AccordionTrigger>Onde posso achar o curso?</AccordionTrigger>
              <AccordionContent className="text-wrap text-justify">
